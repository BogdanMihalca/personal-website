...
const CyberTerminal = () => {
  return (
    <div className="bg-black/70 backdrop-blur-md p-4 border border-fuchsia-500/50 rounded-md my-6 relative overflow-hidden shadow-lg">
      <motion.div
      ...
      <div className="flex items-center justify-between mb-3 border-b border-fuchsia-800/30 pb-2">
        <div className="flex items-center">
          ...
          <span className="text-fuchsia-500 font-mono text-sm">
      ...
      <p className="font-mono text-gray-300 pl-4 border-l border-cyan-500/50 text-sm leading-relaxed">
